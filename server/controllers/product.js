...
exports.create = (req, res) => {
    ...
    form.parse(req, (err, fields, files) => {
        ...
        if (files.photo) {
            /**
             * membuat ketentuan bahwa foto tidak boleh melebihi 1000000 / 1mb
             */
...
exports.list = (req, res) => {
    /**
     * membuat parameter parameter tertentu untuk format list produk yang akan tampil
     * order = asc (ascending)
     * sortir bedasarakan id
     * limit hingga 6 produk
     */
...
exports.decreaseQuantity = (req, res, next) => {
    let bulkOps = req.body.order.products.map(item => {
        return {
            /**
             * quantity = barang di database
             * sold = barang yang terjual
             */
            updateOne: {
                filter: { _id: item._id },
